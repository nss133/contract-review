...
var Formal = (function () {
  ...
  // 회사 주소 정본 — 2026-07-31 사용자 확인, 이전 정본: 서울특별시 영등포구 국제금융로 56
  // (여의도동, 미래에셋증권빌딩 → 구주소 경고로 강등. samples/internal-standards
  // 보안관리약정서 서명란은 구주소 표본). 사옥 이전·주소 개정 시 아래 상수들(정본·KEY·구주소)을 함께 갱신할 것.
