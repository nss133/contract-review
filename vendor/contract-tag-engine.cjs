...
module.exports = __toCommonJS(contract_tag_profile_exports);
...
0 && (module.exports = {
  CONTRACT_TAG_PROFILE_VERSION,
  CONTRACT_TAG_TAXONOMY,
  compareContractTagFrames,
  compareContractTagSignatures,
  contractTagValues,
  extractContractTagAnalysis
});
